...
var globalScopeInjector = exports.globalScopeInjector = function globalScopeInjector(lib) {
	...
	try {
		for (var _iterator = Object.keys(lib)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var f = _step.value;
